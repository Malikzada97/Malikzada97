...
import { FiZap, FiSettings, FiUsers, FiCheck, FiArrowRight, FiCpu, FiRepeat, FiStar, FiFolder, FiGlobe, FiTrendingUp } from 'react-icons/fi';
...
const AIAutomation = () => {
  ...
  const stats = [
    { icon: FiZap, value: '40+', label: t('aiAutomation.stats.projects'), color: 'text-blue-500' },
    { icon: FiUsers, value: '35+', label: t('aiAutomation.stats.clients'), color: 'text-green-500' },
    { icon: FiRepeat, value: '99%', label: t('aiAutomation.stats.uptime'), color: 'text-purple-500' },
    { icon: FiStar, value: '4+', label: t('aiAutomation.stats.experience'), color: 'text-orange-500' },
  ];
  const features = [
    {
      icon: FiZap,
      title: t('aiAutomation.features.automate.title'),
      description: t('aiAutomation.features.automate.description'),
      color: 'from-blue-500 to-cyan-500'
    },
    {
      icon: FiSettings,
      title: t('aiAutomation.features.integration.title'),
      description: t('aiAutomation.features.integration.description'),
      color: 'from-green-500 to-emerald-500'
    },
    {
      icon: FiCpu,
      title: t('aiAutomation.features.aiDriven.title'),
      description: t('aiAutomation.features.aiDriven.description'),
      color: 'from-purple-500 to-pink-500'
    },
    {
      icon: FiCheck,
      title: t('aiAutomation.features.reliable.title'),
      description: t('aiAutomation.features.reliable.description'),
      color: 'from-orange-500 to-red-500'
    },
    {
      icon: FiUsers,
      title: t('aiAutomation.features.scalable.title'),
      description: t('aiAutomation.features.scalable.description'),
      color: 'from-indigo-500 to-blue-500'
    },
    {
      icon: FiRepeat,
      title: t('aiAutomation.features.repeatable.title'),
      description: t('aiAutomation.features.repeatable.description'),
      color: 'from-yellow-500 to-orange-500'
    },
  ];
  const technologies = [
    { name: 'Zapier', category: 'Automation', icon: '⚡' },
    { name: 'Make (Integromat)', category: 'Workflow', icon: '🔄' },
  ...
  const processSteps = [
    {
      step: '01',
      title: t('aiAutomation.process.discovery.title'),
      description: t('aiAutomation.process.discovery.description'),
      icon: FiStar
    },
    {
      step: '02',
      title: t('aiAutomation.process.design.title'),
      description: t('aiAutomation.process.design.description'),
      icon: FiSettings
    },
    {
      step: '03',
      title: t('aiAutomation.process.development.title'),
      description: t('aiAutomation.process.development.description'),
      icon: FiZap
    },
    {
      step: '04',
      title: t('aiAutomation.process.testing.title'),
      description: t('aiAutomation.process.testing.description'),
      icon: FiCheck
    },
    {
      step: '05',
      title: t('aiAutomation.process.deployment.title'),
      description: t('aiAutomation.process.deployment.description'),
      icon: FiGlobe
    },
    {
      step: '06',
      title: t('aiAutomation.process.support.title'),
      description: t('aiAutomation.process.support.description'),
      icon: FiUsers
    },
  ];
  const benefits = [
    t('aiAutomation.benefits.efficiency'),
    t('aiAutomation.benefits.errorReduction'),
    t('aiAutomation.benefits.scalable'),
    t('aiAutomation.benefits.customizable'),
    t('aiAutomation.benefits.integration'),
    t('aiAutomation.benefits.analytics'),
  ];
  const pricingPlans = [
    {
      name: t('aiAutomation.pricing.basic.name'),
      price: t('aiAutomation.pricing.basic.price'),
      description: t('aiAutomation.pricing.basic.description'),
      features: [
        t('aiAutomation.pricing.basic.features.single'),
        t('aiAutomation.pricing.basic.features.integration'),
        t('aiAutomation.pricing.basic.features.analytics'),
        t('aiAutomation.pricing.basic.features.support'),
      ],
      popular: false
    },
    {
      name: t('aiAutomation.pricing.professional.name'),
      price: t('aiAutomation.pricing.professional.price'),
      description: t('aiAutomation.pricing.professional.description'),
      features: [
        t('aiAutomation.pricing.professional.features.multichannel'),
        t('aiAutomation.pricing.professional.features.aiDriven'),
        t('aiAutomation.pricing.professional.features.automation'),
        t('aiAutomation.pricing.professional.features.integration'),
        t('aiAutomation.pricing.professional.features.support'),
      ],
      popular: true
    },
    {
      name: t('aiAutomation.pricing.enterprise.name'),
      price: t('aiAutomation.pricing.enterprise.price'),
      description: t('aiAutomation.pricing.enterprise.description'),
      features: [
        t('aiAutomation.pricing.enterprise.features.custom'),
        t('aiAutomation.pricing.enterprise.features.enterprise'),
        t('aiAutomation.pricing.enterprise.features.security'),
        t('aiAutomation.pricing.enterprise.features.analytics'),
        t('aiAutomation.pricing.enterprise.features.integration'),
        t('aiAutomation.pricing.enterprise.features.support'),
      ],
      popular: false
    },
  ];
  const faqs = [
    {
      question: t('aiAutomation.faq.timeline.question'),
      answer: t('aiAutomation.faq.timeline.answer')
    },
    {
      question: t('aiAutomation.faq.integration.question'),
      answer: t('aiAutomation.faq.integration.answer')
    },
    {
      question: t('aiAutomation.faq.security.question'),
      answer: t('aiAutomation.faq.security.answer')
    },
    {
      question: t('aiAutomation.faq.support.question'),
      answer: t('aiAutomation.faq.support.answer')
    },
    {
      question: t('aiAutomation.faq.customization.question'),
      answer: t('aiAutomation.faq.customization.answer')
    },
    {
      question: t('aiAutomation.faq.cost.question'),
      answer: t('aiAutomation.faq.cost.answer')
    },
  ];
  return (
    <>
      <Helmet>
        <title>{t('aiAutomation.meta.title')}</title>
        <meta name="description" content={t('aiAutomation.meta.description')} />
        <meta name="keywords" content={t('aiAutomation.meta.keywords')} />
        <meta property="og:title" content={t('aiAutomation.meta.ogTitle')} />
        <meta property="og:description" content={t('aiAutomation.meta.ogDescription')} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://mudassirjaved.com/services/ai-automation" />
        <link rel="canonical" href="https://mudassirjaved.com/services/ai-automation" />
      </Helmet>
      <div className="min-h-screen">
            ...
            <motion.div variants={containerVariants} initial="hidden" animate={heroVisible ? "visible" : "hidden"} className="text-center space-y-10">
              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-4">
                ...
                <Button variant="outline" size="xl" className="group hover-lift text-lg font-semibold px-8 py-4 border-2" asChild>
                  <a href="#pricing">
                    {t('aiAutomation.hero.secondaryCta')}
                    <FiArrowRight className="ml-3 group-hover:translate-x-1 transition-transform" />
                  </a>
                </Button>
              </motion.div>
        ...
        <section ref={statsRef} className="py-20 bg-gray-50">
          <div className="container-custom">
            <motion.div variants={containerVariants} initial="hidden" animate={statsVisible ? 'visible' : 'hidden'} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-10">
        ...
        <section ref={benefitsRef} className="py-20 bg-gray-50">
          <div className="container-custom">
            <motion.div variants={containerVariants} initial="hidden" animate={benefitsVisible ? 'visible' : 'hidden'} className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-10">
              ...
              <MagneticCard className="p-12 text-center" glass={true}>
                <div className="max-w-2xl mx-auto space-y-6">
                  <h2 className="text-h2 font-bold">
                    {t('aiAutomation.cta.title')}
                  </h2>
                  <p className="text-body-lg text-muted-foreground">
                    {t('aiAutomation.cta.description')}
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button size="lg" variant="gradient" className="group" asChild>
                      <Link to="/contact">
                        {t('aiAutomation.cta.button')}
                    ...
                    <Button size="lg" variant="outline" className="group" asChild>
                      <Link to="/pricing">
                        ...
                        {t('aiAutomation.cta.secondaryButton')}
                      </Link>
                    </Button>
                  </div>
                </div>
